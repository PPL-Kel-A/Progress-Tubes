        ...
        <form method="POST" action="{{ route('admin.about.update') }}" enctype="multipart/form-data">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-xs font-semibold text-gray-500 mb-1">Badge Text <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-gray-500 mb-1">Subtitle <span class="text-red-500">*</span></label>
                    ...
                    <div class="md:col-span-2">
                        <label class="block text-xs font-semibold text-gray-500 mb-1">Judul Utama <span class="text-red-500">*</span></label>
                    ...
                    <div class="md:col-span-2">
                        <label class="block text-xs font-semibold text-gray-500 mb-1">Deskripsi <span class="text-red-500">*</span></label>
        ...
        <form method="POST" action="{{ route('admin.about.update') }}" enctype="multipart/form-data">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-6">
                ...
                <div class="bg-gray-50 rounded-xl p-5 border border-gray-100">
                    ...
                    <div class="space-y-3">
                        <div>
                            <label class="block text-xs font-semibold text-gray-500 mb-1">Judul <span class="text-red-500">*</span></label>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-gray-50 rounded-xl p-5 border border-gray-100">
                        ...
                        <div class="space-y-3">
                            <div>
                                <label class="block text-xs font-semibold text-gray-500 mb-1">Tahun <span class="text-red-500">*</span></label>
    ...
    <div x-show="activeTab === 'team'" x-transition>
        <form method="POST" action="{{ route('admin.about.update') }}" enctype="multipart/form-data">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                {{-- Team Description --}}
                <div class="mb-6">
                    <label class="block text-xs font-semibold text-gray-500 mb-1">Deskripsi Tim <span class="text-red-500">*</span></label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div class="bg-gray-50 rounded-xl p-4 border border-gray-100">
                        ...
                        <div class="space-y-2">
                            <div>
                                <label class="block text-[10px] font-semibold text-gray-400 mb-0.5 uppercase tracking-wider">Nama <span class="text-red-500">*</span></label>
                            ...
                            <div>
                                <label class="block text-[10px] font-semibold text-gray-400 mb-0.5 uppercase tracking-wider">Jabatan <span class="text-red-500">*</span></label>

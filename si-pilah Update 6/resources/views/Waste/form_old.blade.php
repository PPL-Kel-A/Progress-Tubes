...
<!-- MAP PICKER FOR TPS SELECTION -->
<div>
    <label class="label">Select Waste Collection Point (TPS) on Map *</label>
    <x-map-picker />
</div>

<!-- TPS (Dropdown alternative) -->
<div>
    <label class="label">Or Select TPS from List *</label>
    <select id="tps" name="tps" required class="input" onchange="stepLocation(1)">
        ...
        <option>TPS Jagakarsa</option>
        <option>TPS Kramat Jati</option>
    </select>
</div>

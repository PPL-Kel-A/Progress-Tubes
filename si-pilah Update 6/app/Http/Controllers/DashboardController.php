...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        // Jadwal penjemputan mendatang (10 terdekat)
        $jadwalMendatang = Schedule::where('waktu_jemput', '>=', now())
                                    ->orderBy('waktu_jemput', 'asc')
                                    ->take(10)
                                    ->get();

        return view('user.dashboard', compact('data', 'riwayatSampah', 'jadwalMendatang')); 
    }

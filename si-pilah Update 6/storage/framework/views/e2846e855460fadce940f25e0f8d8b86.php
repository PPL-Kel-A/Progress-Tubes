...
<body class="bg-gray-50 text-gray-800">
    ...
    <div class="min-h-screen" style="background: linear-gradient(135deg, #f0fdf4 0%, #f8fafc 50%, #ecfdf5 100%);">
        <div class="container mx-auto px-4 sm:px-6 py-8 max-w-4xl">
            ...
            <div class="mb-8">
                <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center gap-2 text-sm font-semibold text-green-700 hover:text-green-900 transition group mb-4">
            ...
            <?php if($announcements->count() > 0): ?>
                <div class="space-y-4">
                    ...
                    ?>
                    <div class="group bg-white rounded-2xl border <?php echo e($isNew ? 'border-green-200 shadow-md' : 'border-gray-100 shadow-sm'); ?> overflow-hidden hover:shadow-lg transition-all duration-300">
                        <div class="flex">
                            
                            <div class="w-1.5 flex-shrink-0 <?php echo e($isNew ? 'bg-gradient-to-b from-green-500 to-emerald-500' : 'bg-gray-200'); ?>"></div>
                            ...
                            <div class="flex-1 px-6 py-5">
                                <div class="flex items-start justify-between gap-4">
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="flex items-center gap-2 mb-3">
                                            ...
                                            <span class="text-xs text-gray-400 font-medium">
                                                <?php echo e($announcement->created_at->translatedFormat('l, d F Y')); ?>
                                        ...
                                        <p class="text-gray-700 leading-relaxed text-[15px]">
                                            <?php echo e($announcement->konten); ?>
                                    ...
                                    <div class="flex-shrink-0 mt-1">
                                        <div class="w-10 h-10 rounded-xl <?php echo e($isNew ? 'bg-green-50 text-green-600' : 'bg-gray-50 text-gray-400'); ?> flex items-center justify-center">
...
<?php /**PATH C:\xampp\htdocs\si-pilah Update 6\resources\views/user/announcements.blade.php ENDPATH**/ ?>
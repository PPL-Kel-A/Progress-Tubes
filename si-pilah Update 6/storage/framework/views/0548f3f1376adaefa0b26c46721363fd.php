...
<head>
    ...
    <title>Pengaturan Profil — <?php echo e(config('app.name', 'Si-Pilah')); ?></title>
...
<body class="antialiased" style="background: linear-gradient(135deg, #f0fdf4 0%, #ecfdf5 40%, #f0f9e8 100%); min-height: 100vh;">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center gap-2 text-sm font-semibold text-green-700 hover:text-green-900 transition group">
            ...
            <div class="relative px-8 py-10 flex flex-col sm:flex-row items-start sm:items-center gap-6">
                ...
                <div class="flex-shrink-0">
                    <?php if(auth()->user()->profile_photo): ?>
                        <img src="<?php echo e(asset('profile-photos/' . auth()->user()->profile_photo)); ?>"
                             alt="Profile Photo"
...
$message = $__bag->first($__errorArgs[0]); ?>
                                <p class="text-xs text-red-600 mt-1 font-medium"><?php echo e($message); ?></p>
                            <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php if(auth()->user()->profile_photo): ?>
                        <div class="mt-4 pt-4 border-t border-gray-100">
                            <form method="POST" action="<?php echo e(route('profile.photo.delete')); ?>" onsubmit="return confirm('Yakin ingin menghapus foto profil?')">
                                <?php echo csrf_field(); ?>
                            ...
                            <?php if(session('status') === 'photo-deleted'): ?>
                                <p x-data="{ show: true }" x-show="show" x-transition.opacity.duration.500ms x-init="setTimeout(() => show = false, 3000)"
...
</html><?php /**PATH C:\xampp\htdocs\si-pilah Update 6\resources\views/profile/edit.blade.php ENDPATH**/ ?>
...
<body class="bg-gray-50 text-gray-800">
    ...
    <?php echo $__env->make('partials.navbar', ['variant' => 'dashboard'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div class="container mx-auto px-6 py-10">
        ...
        <div class="bg-sipilah-green rounded-2xl p-8 text-white mb-10 shadow-lg relative overflow-hidden">
            <div class="relative z-10 w-full md:w-2/3">
                ...
                <div class="flex gap-3 flex-wrap">
                    <a href="<?php echo e(route('waste.select')); ?>"
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-center space-x-4 hover:shadow-md transition">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800"><?php echo e(number_format($data['poin_reward'])); ?> <span class="text-sm font-normal">Pts</span></p>
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-center space-x-4 hover:shadow-md transition">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800"><?php echo e(number_format($data['total_sampah'], 1)); ?> <span class="text-sm font-normal">Kg</span></p>
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-center space-x-4 hover:shadow-md transition">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800"><?php echo e(number_format($data['energi_surya_kwh'], 1)); ?> <span class="text-sm font-normal">kWh</span></p>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="<?php echo e(route('waste.select')); ?>" class="text-sm font-semibold text-sipilah-green hover:underline">+ Setor Baru</a>
        </div>
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mb-10">
            <?php if($riwayatSampah->count() > 0): ?>
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            <?php $__currentLoopData = $riwayatSampah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $waste): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50/50">
                                ...
                                <td class="px-5 py-3 text-gray-700"><?php echo e($waste->category); ?></td>
                                <td class="px-5 py-3 font-semibold text-gray-800"><?php echo e(number_format($waste->weight, 2)); ?> Kg</td>
                                <td class="px-5 py-3 text-gray-600"><?php echo e(number_format($waste->result, 2)); ?></td>
                                <td class="px-5 py-3 text-gray-500 text-xs max-w-[150px] truncate" title="<?php echo e($waste->tps); ?>"><?php echo e($waste->tps); ?></td>
                                <td class="px-5 py-3 text-gray-400 text-xs"><?php echo e($waste->created_at->format('d/m/Y H:i')); ?></td>
                            </tr>
            ...
            <?php else: ?>
                <div class="py-10 text-center">
                    ...
                    <p class="text-gray-400 font-medium text-sm">Belum ada setoran sampah. <a href="<?php echo e(route('waste.select')); ?>" class="text-sipilah-green font-bold hover:underline">Mulai setor →</a></p>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mb-10">
            <?php if($jadwalMendatang->count() > 0): ?>
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            ?>
                            <tr class="hover:bg-green-50/30 transition <?php echo e($isToday ? 'bg-green-50/50' : ''); ?>">
                                <td class="px-5 py-4">
                                    <div class="flex items-center gap-3">
                                        <div class="flex-shrink-0 w-12 h-12 rounded-xl flex flex-col items-center justify-center text-center <?php echo e($isToday ? 'bg-green-600 text-white' : 'bg-gray-100 text-gray-600'); ?>">
                                            <span class="text-xs font-bold leading-none"><?php echo e($waktu->translatedFormat('d')); ?></span>
                                            <span class="text-[10px] uppercase leading-none mt-0.5"><?php echo e($waktu->translatedFormat('M')); ?></span>
                                        </div>
                                        <div>
                                            <p class="font-semibold text-gray-800"><?php echo e($waktu->translatedFormat('l, d F Y')); ?></p>
                                            <p class="text-xs text-gray-500 mt-0.5">🕐 <?php echo e($waktu->format('H:i')); ?> WIB</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-5 py-4">
                                    <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-emerald-100 text-emerald-700">
                                        ♻️ <?php echo e($jadwal->kategori); ?>
                                ...
                                <td class="px-5 py-4">
                                    <div class="flex items-center gap-2">
                                        <div class="w-7 h-7 rounded-lg bg-gray-100 flex items-center justify-center text-xs font-bold text-gray-600">
                                            <?php echo e(strtoupper(substr($jadwal->nama_petugas, 0, 1))); ?>

                                        </div>
                                        <span class="text-gray-700 font-medium"><?php echo e($jadwal->nama_petugas); ?></span>
                                    </div>
                                </td>
                                <td class="px-5 py-4">
                                    <?php if($isToday): ?>
                                    ...
                                    <?php else: ?>
                                        <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-bold bg-blue-50 text-blue-600">
                                            <span class="w-1.5 h-1.5 rounded-full bg-blue-400"></span> <?php echo e($waktu->diffForHumans()); ?>
...
</html><?php /**PATH C:\xampp\htdocs\si-pilah Update 6\resources\views/user/dashboard.blade.php ENDPATH**/ ?>
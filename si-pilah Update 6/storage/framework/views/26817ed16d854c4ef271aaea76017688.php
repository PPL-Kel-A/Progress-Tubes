...
<footer class="bg-gray-900 text-white mt-16">
    <div class="container mx-auto px-6 py-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div>
                ...
                <div class="flex space-x-4 mt-6">
                    <a href="javascript:void(0);" class="text-gray-400 hover:text-green-400 transition">
        ...
        <div class="border-t border-gray-800 mt-10 pt-6 text-center">
            <p class="text-xs text-gray-500">&copy; <?php echo e(date('Y')); ?> Si-Pilah. All rights reserved.</p>
        </div>
    </div>
</footer>
<?php /**PATH C:\xampp\htdocs\si-pilah Update 6\resources\views/partials/footer.blade.php ENDPATH**/ ?>
...
<div class="max-w-5xl mx-auto px-6 py-16">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <a href="<?php echo e(route('process.flow')); ?>" class="group">
        ...
        <a href="<?php echo e(route('waste.process')); ?>" class="group">
            <div class="bg-white rounded-3xl p-10 shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-gray-50 
                        hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 h-full flex flex-col items-center text-center">
        ...
        <a href="<?php echo e(route('panduan.setor')); ?>" class="group">
            <div class="bg-white rounded-3xl p-10 shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-gray-50 
                        hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 h-full flex flex-col items-center text-center">
        ...
        <a href="<?php echo e(route('rules')); ?>" class="group">
            <div class="bg-white rounded-3xl p-10 shadow-[0_4px_20px_rgba(0,0,0,0.05)] border border-gray-50 
                        hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 h-full flex flex-col items-center text-center">
...
</html><?php /**PATH C:\xampp\htdocs\si-pilah Update 6\resources\views/waste/guidelines.blade.php ENDPATH**/ ?>
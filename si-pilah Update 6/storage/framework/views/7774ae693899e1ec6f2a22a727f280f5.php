...
<nav class="bg-white border-b-4 border-green-800 shadow-sm py-4 sticky top-0 z-50">
    <div class="container mx-auto px-6 flex justify-between items-center">
        ...
        <div class="hidden md:flex space-x-8 font-bold text-sipilah-green uppercase text-sm tracking-wider items-center">
            ...
            <a href="<?php echo e(route('education.index')); ?>" class="hover:text-green-600 transition">Education</a>
            ...
            <div class="flex items-center space-x-1 relative" x-data="{ open: false }">
                ...
                <div x-show="open" x-transition @click.away="open = false"
                    ...
                    <a href="<?php echo e(route('waste.guidelines')); ?>" class="block px-4 py-2 hover:bg-green-100">Guidelines & Rules</a>
                </div>
            </div>

            <a href="#" class="hover:text-green-600 transition">Reward</a>
            <a href="<?php echo e(route('about')); ?>" class="hover:text-green-600 transition <?php echo e(request()->routeIs('about') ? 'text-green-600 border-b-2 border-green-600 pb-1' : ''); ?>">About</a>
            <a href="<?php echo e(route('contact')); ?>" class="hover:text-green-600 transition <?php echo e(request()->routeIs('contact') ? 'text-green-600 border-b-2 border-green-600 pb-1' : ''); ?>">Contact</a>
        </div>
        ...
        <div class="flex items-center space-x-3">
            <?php if(auth()->guard()->check()): ?>
                ...
                <?php if(Auth::user()->is_admin): ?>
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="hidden md:inline-flex items-center gap-1.5 bg-sipilah-green text-white px-4 py-2 text-xs font-bold uppercase rounded-lg shadow hover:bg-green-700 transition">
                ...
                <?php if(($variant ?? 'welcome') === 'welcome'): ?>
                    <span class="hidden md:inline-block font-bold text-sm text-sipilah-green whitespace-nowrap"><?php echo e(Auth::user()->name); ?></span>
                <?php endif; ?>
                ...
                ?>
                <a href="<?php echo e(route('announcements.index')); ?>" class="relative p-2 rounded-xl hover:bg-green-50 transition group" title="Pengumuman">
                    ...
                    <div class="relative">
                        <button @click="openProfile = !openProfile" class="rounded-full bg-gradient-to-tr from-green-400 to-[#1b5e20] p-[2.5px] hover:scale-105 transition-transform duration-300 shadow-sm focus:outline-none">
                            <?php if(Auth::user()->profile_photo): ?>
                                <img src="<?php echo e(asset('profile-photos/' . Auth::user()->profile_photo)); ?>" alt="Profile" class="h-9 w-9 rounded-full object-cover">
                            <?php else: ?>
                        ...
                        <div x-show="openProfile" x-transition @click.away="openProfile = false"
                            ...
                            <a href="<?php echo e(route('profile.edit')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-green-50 rounded-t-lg">Pengaturan Profil</a>
...
<?php /**PATH C:\xampp\htdocs\si-pilah Update 6\resources\views/partials/navbar.blade.php ENDPATH**/ ?>
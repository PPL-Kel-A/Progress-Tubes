...
<div class="bg-green-700 text-white h-16 flex items-center justify-center relative shadow-md">
    ...
    <a href="/waste/form?type=<?php echo e($data['type'] ?? ''); ?>"
    ...
    <div class="w-full max-w-3xl space-y-10">
        ...
        <div class="bg-white p-12 rounded-3xl shadow-lg space-y-8">
            ...
            <div>
                ...
                <span class="bg-green-100 text-green-700 px-5 py-2 rounded-full text-sm font-bold">
                    <?php echo e(($data['type'] ?? '') == 'organic' ? 'Organic Waste' : 'Inorganic Waste'); ?>
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    <?php echo e($data['desa'] ?? '-'); ?>, <?php echo e($data['kecamatan'] ?? '-'); ?>, <?php echo e($data['kota'] ?? '-'); ?>
        ...
        <div class="bg-white p-12 rounded-3xl shadow-lg">
            ...
            <div class="relative flex items-center justify-between">
                ...
                <div class="z-10 flex flex-col items-center w-1/3 text-center">
                    ...
                    <p class="text-xs text-gray-500">
                        <?php echo e(($data['type'] ?? '') == 'organic' ? 'Eco Enzyme' : 'Fuel Conversion'); ?>
                ...
                <div class="z-10 flex flex-col items-center w-1/3 text-center">
                    ...
                    <p class="mt-4 font-bold text-lg text-gray-800">
                        <?php echo e(number_format($result ?? 0,2)); ?> L
                    </p>
            ...
            <div class="mt-12 bg-gray-50 p-6 rounded-2xl text-center">
                ...
                <p class="text-lg font-semibold text-gray-800">
                    <?php echo e(($data['type'] ?? '') == 'organic'
                        ? '1 kg = 0.5 liter eco enzyme'
                        : '1 kg = 0.8 liter fuel'); ?>

                </p>
                <p class="mt-3 text-gray-600">
                    <?php echo e($data['weight'] ?? 0); ?> ×
                    <?php echo e(($data['type'] ?? '') == 'organic' ? '0.5' : '0.8'); ?>

                    =
                    <span class="font-bold text-green-700">
                        <?php echo e(number_format($result ?? 0,2)); ?> liters
                    </span>
                </p>
            </div>
        </div>
        ...
        <div class="space-y-3">
            ...
            <form action="/waste/store" method="POST">
                ...
                <input type="hidden" name="category" value="<?php echo e($data['category'] ?? ''); ?>">
                <input type="hidden" name="weight" value="<?php echo e($data['weight'] ?? ''); ?>">
                <input type="hidden" name="tps" value="<?php echo e($data['tps'] ?? ''); ?>">
                <input type="hidden" name="desa" value="<?php echo e($data['desa'] ?? ''); ?>">
                <input type="hidden" name="kecamatan" value="<?php echo e($data['kecamatan'] ?? ''); ?>">
                <input type="hidden" name="kota" value="<?php echo e($data['kota'] ?? ''); ?>">
                <input type="hidden" name="image" value="<?php echo e($image); ?>">
                <input type="hidden" name="result" value="<?php echo e($result ?? 0); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\si-pilah Update 6\resources\views/waste/preview.blade.php ENDPATH**/ ?>
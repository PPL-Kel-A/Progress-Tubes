...
<head>
    ...
    <style>
        ...
        .about-hero::before {
            ...
            position: absolute;
            inset: 0;
            background: url('<?php echo e($heroBg); ?>') center/cover no-repeat;
            opacity: 0.35;
        }
        .about-hero-content {
            position: relative;
        ...
        .sejarah-section::before {
            ...
            position: absolute;
            inset: 0;
            background: url('<?php echo e($sejarahBg); ?>') center/cover no-repeat;
            opacity: 0.2;
        }
        ...
        <div class="about-hero-content container mx-auto px-6 py-20 md:py-28">
            <div class="max-w-2xl">
                <span class="inline-block bg-white/15 backdrop-blur-sm text-white/90 text-xs font-bold uppercase tracking-widest px-4 py-1.5 rounded-full mb-4 border border-white/20">
                    <?php echo e($hero['badge'] ?? 'SI-PILAH'); ?>

                </span>
                <p class="text-green-200 text-sm mb-2 font-medium"><?php echo e($hero['subtitle'] ?? 'Platform pengelolaan sampah terpadu'); ?></p>
                <h1 class="text-3xl md:text-5xl font-extrabold text-white leading-tight mb-4">
                    <?php echo e($hero['title'] ?? 'Solusi mutakhir untuk pengelolaan sampah yang terintegrasi'); ?>

                </h1>
                <p class="text-green-100/80 text-sm md:text-base max-w-lg leading-relaxed">
                    <?php echo e($hero['description'] ?? 'Mengubah cara masyarakat mengelola sampah melalui teknologi digital, edukasi, dan kolaborasi komunitas.'); ?>
            ...
            <div class="flex flex-col md:flex-row items-center gap-10 md:gap-16 max-w-6xl mx-auto">
                ...
                <div class="w-full md:w-1/2 animate-fade-in-up">
                    <div class="rounded-2xl overflow-hidden shadow-xl border-4 border-white">
                        <img src="<?php echo e($visiImage); ?>" alt="Relawan SI-Pilah membersihkan lingkungan" class="w-full h-[280px] md:h-[340px] object-cover hover:scale-105 transition-transform duration-700">
                    </div>
                </div>
                    ...
                    <div class="space-y-4">
                        <div class="bg-white rounded-xl p-5 border border-gray-100 shadow-sm">
                            <h3 class="font-bold text-sipilah-green mb-2 flex items-center gap-2">
                                ...
                                <?php echo e($visi['title'] ?? 'Visi SI-Pilah'); ?>

                            </h3>
                            <p class="text-sm text-gray-600 leading-relaxed"><?php echo e($visi['description'] ?? ''); ?></p>
                        </div>
                        <div class="bg-white rounded-xl p-5 border border-gray-100 shadow-sm">
                            <h3 class="font-bold text-sipilah-green mb-2 flex items-center gap-2">
                                <span class="w-8 h-8 flex items-center justify-center rounded-lg bg-green-100 text-green-700">
                                ...
                                <?php echo e($strategi['title'] ?? 'Strategi Kami'); ?>

                            </h3>
                            <p class="text-sm text-gray-600 leading-relaxed"><?php echo e($strategi['description'] ?? ''); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <?php for($i = 1; $i <= 4; $i++): ?>
                        ...
                        <div class="flex flex-col md:flex-row items-center gap-6">
                            ...
                            <div class="w-full md:w-5/12 text-right">
                                <div class="<?php echo e($isLast ? 'bg-green-500/20 border-green-500/30 hover:bg-green-500/25' : 'bg-white/10 border-white/10 hover:bg-white/15'); ?> backdrop-blur-sm rounded-xl p-5 border transition">
                                    <span class="text-green-400 font-bold text-sm"><?php echo e($year); ?></span>
                                    <h4 class="text-white font-bold mt-1"><?php echo e($title); ?></h4>
                                    <p class="text-gray-300 text-sm mt-2 leading-relaxed"><?php echo e($desc); ?></p>
                                </div>
                            </div>
    ...
    <section id="team" class="py-16 md:py-20 bg-about-soft">
        <div class="container mx-auto px-6">
            ...
            <p class="text-center text-gray-500 text-sm max-w-2xl mx-auto mb-14 leading-relaxed">
                "<?php echo e($team['description'] ?? 'Kami adalah tim yang berdedikasi tinggi dalam menciptakan solusi inovatif untuk pengelolaan sampah yang berkelanjutan di Indonesia.'); ?>"
            </p>

            <div class="max-w-4xl mx-auto">
                
                <?php if(($team['member_1_name'] ?? '') !== ''): ?>
                <div class="flex justify-center mb-10">
                    <div class="text-center group">
                        ...
                        <h4 class="font-bold text-gray-800 text-sm group-hover:text-sipilah-green transition"><?php echo e($team['member_1_name']); ?></h4>
                        <p class="text-xs text-gray-500 mt-0.5"><?php echo e($team['member_1_role'] ?? ''); ?></p>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-10">
                    <?php for($i = 2; $i <= 4; $i++): ?>
                        <?php if(($team['member_'.$i.'_name'] ?? '') !== ''): ?>
                        <div class="text-center group">
                            <div class="team-avatar mx-auto mb-3">
                                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                            </div>
                            <h4 class="font-bold text-gray-800 text-sm group-hover:text-sipilah-green transition"><?php echo e($team['member_'.$i.'_name']); ?></h4>
                            <p class="text-xs text-gray-500 mt-0.5"><?php echo e($team['member_'.$i.'_role'] ?? ''); ?></p>
                        </div>
                        <?php endif; ?>
                    <?php endfor; ?>
                </div>
                ...
                <?php for($i = 1; $i <= 4; $i++): ?>
                    ...
                    <div class="service-card flex flex-col sm:flex-row">
                        <div class="sm:w-3/5 p-6">
                            <h3 class="font-bold text-gray-800 text-lg mb-2"><?php echo e($lTitle); ?></h3>
                            <p class="text-sm text-gray-500 leading-relaxed"><?php echo e($lDesc); ?></p>
                        </div>
                        <div class="sm:w-2/5">
                            <img src="<?php echo e($lImg); ?>" alt="<?php echo e($lTitle); ?>" class="w-full h-full min-h-[160px] object-cover">
                        </div>
                    </div>
                    <?php endif; ?>
                <?php endfor; ?>
    ...
    <section class="bg-gradient-to-r from-green-800 to-green-600 py-14">
        <div class="container mx-auto px-6 text-center">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <a href="<?php echo e(route('contact')); ?>" class="border-2 border-white text-white font-bold px-8 py-3 rounded-full hover:bg-white hover:text-sipilah-green transition-all duration-300 text-sm uppercase tracking-wider">
                    Hubungi Kami
                </a>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\si-pilah Update 6\resources\views/pages/about.blade.php ENDPATH**/ ?>
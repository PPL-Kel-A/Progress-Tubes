...
<div class="w-full max-w-xl px-4">
    ...
    <div class="bg-gradient-to-r from-green-500 to-green-700 text-white p-6 rounded-2xl shadow-lg mb-6">
        ...
        <h2 class="text-4xl font-bold">
            <?php echo e(number_format($result,2)); ?> <span class="text-lg">liters</span>
        </h2>

        <p class="text-sm opacity-90 mt-1">
            <?php echo e($type == 'organic' ? 'Eco Enzyme' : 'Fuel (solar)'); ?>
    ...
    <div class="bg-white p-6 rounded-2xl shadow mb-6">
        ...
        <div class="grid grid-cols-2 gap-4 text-sm">
            <div>
                ...
                <p class="font-semibold"><?php echo e($name); ?></p>
            </div>

            <div>
                <p class="text-gray-400">Category</p>
                <p class="font-semibold"><?php echo e($category); ?></p>
            </div>

            <div>
                <p class="text-gray-400">Waste Type</p>
                <p class="font-semibold">
                    <?php echo e($type == 'organic' ? 'Organic Waste' : 'Inorganic Waste'); ?>
            ...
            <div>
                ...
                <p class="font-semibold"><?php echo e($weight); ?> kg</p>
            </div>

            <div class="col-span-2">
                <p class="text-gray-400">Location</p>
                <p class="font-semibold">
                    <?php echo e($tps); ?> - <?php echo e($desa); ?>, <?php echo e($kecamatan); ?>, <?php echo e($kota); ?>
...
</html><?php /**PATH C:\xampp\htdocs\si-pilah Update 6\resources\views/waste/success.blade.php ENDPATH**/ ?>
...
<body class="bg-gray-50 text-gray-800">
    ...
    <div class="container mx-auto px-6 py-10 max-w-2xl">
        ...
        <div class="mb-6">
            <a href="<?php echo e(route('reports.index')); ?>" class="text-sm text-sipilah-green font-semibold hover:underline">← Kembali ke Daftar Laporan</a>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            <form method="POST" action="<?php echo e(route('reports.store')); ?>" class="space-y-6">
                <?php echo csrf_field(); ?>

                <div>
                    <label class="block text-sm font-semibold text-gray-600 mb-2">Judul Laporan *</label>
                    <input type="text" name="judul" value="<?php echo e(old('judul')); ?>" required placeholder="Contoh: Tempat sampah penuh di area TPS Kebon Jeruk" 
                ...
                <div>
                    ...
                    <textarea name="deskripsi" rows="6" required placeholder="Jelaskan detail laporan Anda..." 
                              class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none resize-none transition"><?php echo e(old('deskripsi')); ?></textarea>
                </div>
                ...
                <div class="flex gap-3">
                    ...
                    <a href="<?php echo e(route('reports.index')); ?>" class="px-6 py-3 bg-gray-100 text-gray-600 rounded-xl font-bold text-sm hover:bg-gray-200 transition text-center">
                        Batal
                    </a>
                </div>
            </form>
...
<?php /**PATH C:\xampp\htdocs\si-pilah Update 6\resources\views/reports/create.blade.php ENDPATH**/ ?>
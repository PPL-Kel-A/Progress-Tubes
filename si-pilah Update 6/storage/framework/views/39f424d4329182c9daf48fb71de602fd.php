...
<div id="resultBox"
    ...
    <div class="bg-white/20 backdrop-blur-md p-6 rounded-2xl">
        ...
        <p class="mb-4 text-lg">
            <?php echo e($type == 'organic' ? '1 kg = 0.5 liter eco enzyme' : '1 kg = 0.8 liter fuel'); ?>
        ...
        <p class="text-sm mt-1 opacity-90">
            <?php echo e($type == 'organic' ? 'of eco enzyme' : 'of fuel'); ?>
...
weight.addEventListener('input', () => {
    ...
    let result = <?php echo e($type == 'organic' ? 'val * 0.5' : 'val * 0.8'); ?>;
...
</html><?php /**PATH C:\xampp\htdocs\si-pilah Update 6\resources\views/waste/form.blade.php ENDPATH**/ ?>
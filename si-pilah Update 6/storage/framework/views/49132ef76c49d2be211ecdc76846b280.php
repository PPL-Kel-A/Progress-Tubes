        ...
        <div class="lg:col-span-3 bg-sipilah-green text-white rounded-2xl px-10 py-6 shadow-lg">
            <div class="max-w-3xl">
                <p class="text-green-200 text-sm mb-2">
                    Halo, <?php echo e(auth()->user()->name ?? 'User'); ?> 👋
                </p>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 hover:shadow-md transition"
                ...
                <div class="flex justify-between items-start">
                    <div class="flex-1 min-w-0">
                        <h2 class="font-bold text-gray-800"><?php echo e($report->judul); ?></h2>
                        <p class="text-xs text-gray-400 mt-1">
                            <?php echo e($report->created_at->translatedFormat('d F Y, H:i')); ?>
                    ...
                    <div class="flex items-center gap-3 ml-4">
                        ...
                        <span class="px-3 py-1 rounded-full text-xs font-bold bg-<?php echo e($c); ?>-100 text-<?php echo e($c); ?>-700">
...
</html><?php /**PATH C:\xampp\htdocs\si-pilah Update 6\resources\views/reports/index.blade.php ENDPATH**/ ?>
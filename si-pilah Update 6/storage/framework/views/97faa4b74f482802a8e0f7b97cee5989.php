<?php $__env->startSection('title', 'Kelola Contact'); ?>
<?php $__env->startSection('page-title', 'Kelola Halaman Contact'); ?>
<?php $__env->startSection('page-description', 'Edit informasi kontak yang ditampilkan ke pengunjung'); ?>
...
<div x-data="{ activeTab: 'hero' }" class="space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="contact_hero_title" value="<?php echo e($hero['title'] ?? 'Hubungi Kami'); ?>" class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-sipilah-500 focus:border-transparent outline-none">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-gray-50 rounded-xl p-5 border border-gray-100">
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <input type="email" name="contact_info_email_1" value="<?php echo e($info['email_1'] ?? 'info@sipilah.id'); ?>" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-sipilah-500 focus:border-transparent outline-none bg-white">
                            </div>
                            <div>
                                <label class="block text-xs font-semibold text-gray-500 mb-1">Email Support</label>
                                <input type="email" name="contact_info_email_2" value="<?php echo e($info['email_2'] ?? 'support@sipilah.id'); ?>" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-sipilah-500 focus:border-transparent outline-none bg-white">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-xl p-5 border border-gray-100">
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <input type="text" name="contact_info_phone" value="<?php echo e($info['phone'] ?? '(021) 1234-5678'); ?>" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-sipilah-500 focus:border-transparent outline-none bg-white">
                            </div>
                            <div>
                                <label class="block text-xs font-semibold text-gray-500 mb-1">Jam Operasional</label>
                                <input type="text" name="contact_info_phone_hours" value="<?php echo e($info['phone_hours'] ?? 'Senin - Jumat, 08:00 - 17:00 WIB'); ?>" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-sipilah-500 focus:border-transparent outline-none bg-white">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-xl p-5 border border-gray-100 md:col-span-2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            <div>
                                ...
                                <input type="text" name="contact_info_address_1" value="<?php echo e($info['address_1'] ?? 'Jl. Lingkungan Hijau No. 42'); ?>" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-sipilah-500 focus:border-transparent outline-none bg-white">
                            </div>
                            <div>
                                <label class="block text-xs font-semibold text-gray-500 mb-1">Alamat Baris 2</label>
                                <input type="text" name="contact_info_address_2" value="<?php echo e($info['address_2'] ?? 'Jakarta Barat, DKI Jakarta 11530'); ?>" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-sipilah-500 focus:border-transparent outline-none bg-white">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-xl p-5 border border-gray-100 md:col-span-2">
                        ...
                        <div>
                            ...
                            <input type="url" name="contact_info_maps_url" value="<?php echo e($info['maps_url'] ?? ''); ?>" placeholder="https://www.google.com/maps/embed?pb=..." class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-sipilah-500 focus:border-transparent outline-none bg-white">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-gray-50 rounded-xl p-5 border border-gray-100">
                        ...
                        <input type="url" name="contact_sosmed_facebook" value="<?php echo e($sosmed['facebook'] ?? ''); ?>" placeholder="https://facebook.com/sipilah" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-sipilah-500 focus:border-transparent outline-none bg-white">
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-xl p-5 border border-gray-100">
                        ...
                        <input type="url" name="contact_sosmed_twitter" value="<?php echo e($sosmed['twitter'] ?? ''); ?>" placeholder="https://twitter.com/sipilah" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-sipilah-500 focus:border-transparent outline-none bg-white">
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-xl p-5 border border-gray-100">
                        ...
                        <input type="url" name="contact_sosmed_instagram" value="<?php echo e($sosmed['instagram'] ?? ''); ?>" placeholder="https://instagram.com/sipilah" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-sipilah-500 focus:border-transparent outline-none bg-white">
                    </div>
                    ...
                    <div class="bg-gray-50 rounded-xl p-5 border border-gray-100">
                        ...
                        <input type="text" name="contact_sosmed_whatsapp" value="<?php echo e($sosmed['whatsapp'] ?? ''); ?>" placeholder="6281234567890" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-sipilah-500 focus:border-transparent outline-none bg-white">
    ...
    <div class="text-center">
        <a href="<?php echo e(route('contact')); ?>" target="_blank" class="inline-flex items-center gap-2 text-sm text-sipilah-700 hover:text-sipilah-900 font-semibold transition">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\si-pilah Update 6\resources\views/admin/contact.blade.php ENDPATH**/ ?>